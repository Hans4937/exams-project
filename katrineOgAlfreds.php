...
<!-- Code for Shopkatrine og Alfreds-->
<h1 id="ShopAllProduct">Shop Katrine og Alfreds</h1>
...
<div class="GridItemAllProduct">
  <!-- Adding the picture for Katriene og Alfreds Agurker-->
  <img src="./img/product/katrineogalfredsagurkereco.jpeg" alt="Katriene og Alfreds Agurker">
    <!-- description and header of Katriene og Alfreds Agurker-->
    <h2>Katriene og Alfreds Agurker</h2>
    <p>Description of Katriene og Alfreds Agurker.</p>
    <!-- quantity function in Katriene og Alfreds Agurker-->
  <input type="number" min="1" placeholder="Quantity">
  <!-- Add to cart for Katriene og Alfreds Agurker -->
